...
namespace SimplifiedNorthwind.Pages
{
    public partial class SolutionUsers
    {
        ...
        protected IEnumerable<SimplifiedNorthwind.Models.ConData.SolutionUser> solutionUsers;

        protected RadzenDataGrid<SimplifiedNorthwind.Models.ConData.SolutionUser> grid0;
        ...
        protected async Task EditRow(DataGridRowMouseEventArgs<SimplifiedNorthwind.Models.ConData.SolutionUser> args)
        {
            await DialogService.OpenAsync<EditSolutionUser>("Edit SolutionUser", new Dictionary<string, object> { {"UserID", args.Data.UserID} });
        }

        protected async Task GridDeleteButtonClick(MouseEventArgs args, SimplifiedNorthwind.Models.ConData.SolutionUser solutionUser)
        {
            try
            {
